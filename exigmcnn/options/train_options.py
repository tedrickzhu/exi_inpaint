...
class TrainOptions:
    def __init__(self):
        ...
        self.dataset_training_paths = {
            ...
            'places2': '',
            'imagenet': '',
            'paris_streetview': '', #'/home/zzy/work/inpainting_gmcnn/tensorflow/imgs/paris-streetview_256x256/',
            'places2full': '',
            'adobe_5k': '',
            'celeba_wild': ''
        }
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--data_imgfile', type=str, default='./eximage/files/imgfile330.txt', help='the file storing training file paths')
        self.parser.add_argument('--data_eximgfile', type=str, default='./eximage/files/eximgfile330.txt', help='the file storing training file paths')
        self.parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0')
        self.parser.add_argument('--checkpoints_dir', type=str, default='./checkpoints', help='models are saved here')
        self.parser.add_argument('--load_model_dir', type=str, default='./checkpoints/0315/', help='pretrained models are given here')
